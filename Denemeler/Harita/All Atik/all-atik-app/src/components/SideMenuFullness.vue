      ...
      <div class="row q-mb-sm">
        <div class="col-6">
                <span>
                  ...
                  % 0-50 : <strong>{{$store.getters.getFullnessColors.countGreen}}</strong>
                </span>
        </div>
        ...
        <div class="col-6">
                <span>
                  ...
                  % 75-100 : <strong>{{$store.getters.getFullnessColors.countRed}}</strong>
                </span>
        </div>
      ...
      <div class="row">
        <div class="col-6">
                <span>
                  ...
                  % 50-75 : <strong>{{$store.getters.getFullnessColors.countYellow}}</strong>
                </span>
        </div>
        ...
        <div class="col-6">
                <span>
                  ...
                  Veri Yok : <strong>{{$store.getters.getFullnessColors.countGrey}}</strong>
                </span>
        </div>
      </div>
    </q-card-section>
