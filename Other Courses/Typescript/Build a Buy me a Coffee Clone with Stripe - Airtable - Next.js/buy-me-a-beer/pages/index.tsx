...
export default function Home({ donations }: { donations: Record[] }) {
      ...
      <main className="flex max-w-2xl m-auto">
        ...
        <div>
          ...
          <div className="flex items-center w-full mb-2">
            <span className="mr-2">
              <Image src="/beer.svg" alt="beer" width="50" height="100"/>
            </span>
          ...
          <div className="mb-2 w-full">
            ...
            <textarea
              className="shadow rounded w-full border border-blue-500 p-2"
              id="message" onChange={(e) => setMessage(e.target.value)} value={message}
              placeholder="Thank you"
            />
          </div>

          <button onClick={handleCheckout} className="bg-blue-500 rounded shadow px-4 py-2 text-white">
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  ...
  const response = await fetch(`${protocol}://${context.req.headers.host}/api/donations`);
