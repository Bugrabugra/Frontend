    ...
    <div id="faq" className="block faqBlock">
      <div className="container-fluid">
        ...
        <Collapse defaultActiveKey={["1"]} accordion>
          <Collapse.Panel header="How to setup the theme?" key="1">
            <p>
          ...
          <Collapse.Panel header="How to access through cloud?" key="3">
            <p>
          ...
          <Collapse.Panel header="Can I manage multiple task?" key="4">
            <p>
          ...
          <Collapse.Panel header="How can I change my password?" key="5">
            <p>
          ...
          <Collapse.Panel header="How to manage my account?" key="6">
            <p>
        ...
        <div className="quickSupport">
          ...
          <Button type="primary" size="large">
            <i className="fas fa-envelope"/> Email your question
          </Button>
        </div>
      </div>
    </div>
