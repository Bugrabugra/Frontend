...
const Masthead: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        <source
          src="/assets/pexels-david-gallie-10275544.mp4"
      ...
      <div
        className="p-12 font-bold z-10 text-white drop-shadow-[0_5px_3px_rgba(0,0,0,0.4)] text-center
