...
const Upload = () => {
  ...
  return (
    <div
      className="flex w-full h-full absolute left-0 top-[60px] mb-10 pt-10
    lg:pt-20 bg-[#f8f8f8] justify-center"
    >
      <div
        className="bg-white rounded-lg xl:h-[80vh] w-[60%] flex gap-6 flex-wrap
      ...
      >
        <div>
          ...
          <div
            className="
          border-dashed rounded-xl border-4 border-gray-200 flex flex-col
        ...
        <div className="flex flex-col gap-3 pb-10">
          ...
          <select
            ...
            className="outline-none border-2 border-gray-200 text-md capitalize lg:p-4
