  ...
  <main>
    ...
    <form @submit.prevent="handleCreate">
      <label class="block mb-4">
        ...
        <input v-model="newNote.title" class="block w-full text-slate-800 px-4 py-2" type="text"/>
      </label>
    ...
    <div v-if="!notesLoading">
      <div v-for="note in notesData.notes" class="relative bg-white text-slate-700 rounded-lg p-6 mb-6">
        <button class="text-red-500 font-bold absolute top-6 right-6" @click="() => deleteNote({id: note.id})">delete
        </button>
