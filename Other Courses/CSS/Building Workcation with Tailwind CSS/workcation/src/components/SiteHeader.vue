  ...
  <header class="bg-gray-900">
    ...
    <nav v-show="isOpen">
      ...
      <div class="px-2 pt-2 pb-5 border-b border-gray-800">
        <a href="#" class="block px-3 py-1 rounded leading-tight font-semibold text-white hover:bg-gray-800">List your property</a>
        <a href="#" class="mt-1 block px-3 py-1 rounded leading-tight font-semibold text-white hover:bg-gray-800">Trips</a>
        <a href="#" class="mt-1 block px-3 py-1 rounded leading-tight font-semibold text-white hover:bg-gray-800">Messages</a>
      </div>

      <!--Bottom-->
      <div class="px-5 py-5">
        <div class="flex items-center">
          <img class="h-10 w-10 object-cover rounded-full border-2 border-gray-600" src="https://images.unsplash.com/photo-1553514029-1318c9127859?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTh8fHdvbWFuJTIwZmFjZXxlbnwwfHwwfHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60" alt="">
