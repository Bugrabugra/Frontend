<template>
  <header class="bg-gray-900 sm:flex sm:items-center sm:justify-between">
    <div class="flex justify-between px-4 py-3">
      ...
      <div class="flex">
        <!--Hamburger-->
        <button @click="toggle" class="px-2 text-gray-500 hover:text-white sm:hidden">
    ...
    <nav class="sm:flex sm:items-center sm:px-4" :class="{'hidden': !isOpen, 'block': isOpen}">
      ...
      <div class="px-2 pt-2 pb-5 border-b border-gray-800 sm:flex sm:border-b-0 sm:py-0 sm:px-0">
        <a href="#" class="block px-3 py-1 rounded leading-tight font-semibold text-white hover:bg-gray-800 sm:text-sm sm:px-2">List your property</a>
        <a href="#" class="mt-1 sm:mt-0 block px-3 py-1 rounded leading-tight font-semibold text-white hover:bg-gray-800 sm:text-sm sm:px-2 sm:ml-2">Trips</a>
        <a href="#" class="mt-1 sm:mt-0 block px-3 py-1 rounded leading-tight font-semibold text-white hover:bg-gray-800 sm:text-sm sm:px-2 sm:ml-2">Messages</a>
      </div>
