  ...
  <header class="bg-gray-900 sm:flex sm:items-center sm:justify-between xl:bg-white">
    <div class="flex justify-between px-4 py-3 xl:w-72 xl:bg-gray-900 xl:justify-center xl:py-5">
      ...
      <div class="flex sm:hidden">
        <!--Hamburger-->
        <button @click="toggle" class="px-2 text-gray-500 hover:text-white">
    ...
    <nav class="sm:flex sm:items-center sm:px-4 xl:flex-1 xl:justify-between" :class="{'hidden': !isOpen, 'block': isOpen}">
      ...
      <div class="hidden xl:block xl:relative xl:max-w-xs xl:w-full">
        ...
        <input class="block w-full bg-gray-200 border border-transparent focus:outline-none focus:bg-white focus:border-gray-300 text-gray-900 rounded-lg pl-10 pr-4 py-2" type="text" placeholder="Search by keywords">
      </div>

      <div class="sm:flex sm:items-center">
        <div class="px-2 pt-2 pb-5 border-b border-gray-800 sm:flex sm:border-b-0 sm:py-0 sm:px-0">
          <a href="#" class="block px-3 py-1 rounded leading-tight font-semibold text-white hover:bg-gray-800 sm:text-sm sm:px-2 xl:text-gray-900">List your property</a>
          <a href="#" class="mt-1 sm:mt-0 block px-3 py-1 rounded leading-tight font-semibold text-white hover:bg-gray-800 sm:text-sm sm:px-2 sm:ml-2 xl:text-gray-900">Trips</a>
          <a href="#" class="mt-1 sm:mt-0 block px-3 py-1 rounded leading-tight font-semibold text-white hover:bg-gray-800 sm:text-sm sm:px-2 sm:ml-2 xl:text-gray-900">Messages</a>
        </div>
