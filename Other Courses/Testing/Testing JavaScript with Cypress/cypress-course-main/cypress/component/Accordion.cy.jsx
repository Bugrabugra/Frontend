...
describe('Accordion.cy.jsx', () => {
  it('Items accordion', () => {
    ...
    cy.contains("Your tests will exist in a describe block. This block takes two arguments").should("not.be.visible")
    cy.getDataTest("accordion-item-1").within(() => cy.get("[role=button]").click())
    cy.contains("Your tests will exist in a describe block. This block takes two arguments").should("be.visible")
    cy.getDataTest("accordion-item-1").within(() => cy.get("[role=button]").click())
    cy.contains("Your tests will exist in a describe block. This block takes two arguments").should("not.be.visible")
  })
})
